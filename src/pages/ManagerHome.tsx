...
const ManagerHome: React.FC = () => {
  return (
    ...
    <div className="flex flex-col min-h-screen  w-full bg-[#E6EAF5] pr-5">
      {/* Header Section */}
      <div className="  py-2 mt-5 px-6 ml-5 mr-8 bg-gradient-to-l from-accent-10 to-primaryColor-50 rounded-md shadow-sm">
      ...
      <main className=" mx-auto py-6 px-4">
        {/* Top Summary Cards */}
        <div className="grid grid-cols-1 mr-3 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <PendingRequests />
          <ApprovedMissions />
          <MissionsInProgress />
          <TotalSpend />
        ...
        <div className="flex gap-6 max-sm:flex-col mt-8">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 sm:w-[700px] lg:w-[750px] md:grid-cols-2 gap-6">
            <MissionPurpose />
            <MissionsPerEmployee />
            <QuickLinks />
            <RecentActivities />

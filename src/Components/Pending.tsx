    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-primaryColor-10 via-primaryColor-10 to-accent-10 flex flex-col md:flex-row justify-center items-center gap-10 p-5">
            ...
            <div className=" flex gap-40 ">
                ...
                {/* ------------------- Right Side Card ------------------- */}
                <div className="flex justify-center items-center mt-30 h-[250px] md:w-1/2">
                    ...
                    <div className="p-8 bg-white rounded-xl shadow-lg max-w-sm w-full space-y-6 text-center">
                        ...
                        <Link className="w-full px-4 py-3 bg-primaryColor-800 text-white font-semibold rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-75 transition duration-150 ease-in-out">
                            Back to Home
                        </Link>
                    </div>
